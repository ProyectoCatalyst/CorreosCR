(() => {
    ...
    angular
      ...
      .controller('controladorRegistrarClienteAdmin', controladorRegistrarClienteAdmin);
  
      controladorRegistrarClienteAdmin.$inject = ['$http', '$stateParams', '$state', 'servicioUsuarios']; 
      
      //Revisar esto//

      this.googleMapsUrl="https://maps.googleapis.com/maps/api/js?key=map";
    ...
    function controladorRegistrarClienteAdmin($http, $stateParams, $state, servicioUsuarios) {
      let vm = this;
